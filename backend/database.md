...
| `new_value` | LONGTEXT | NULLABLE | Dữ liệu mới sau khi thay đổi (JSON) |
...
erDiagram
    ...
    category ||--o{ class : "danh mục lớp"
    class ||--o{ class_member : "học viên & GV"
    user ||--o{ class_member : "tham gia"
    class ||--o{ class_schedule : "lịch học"
    class ||--o{ class_online : "buổi trực tuyến"
