...
public interface IStudentPortalService {
    ...
    StudentPortalItemResponse.CartItem addToCart(Long userId, Long coursePackageId);
    /** Kiểm tra coupon và tính số tiền giảm trên giỏ hàng hiện tại. */
    StudentPortalItemResponse.CouponValidation validateCoupon(Long userId, String code, Long courseId);
